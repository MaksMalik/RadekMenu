...
import { X, Refrigerator, Sparkles, Loader2, Flame, Zap, Plus, Check } from 'lucide-react';
        ...
        >
          ...
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-bold text-slate-800">Co mam w lodówce?</h2>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-200 focus:border-emerald-400 resize-none"
            />
          </div>
